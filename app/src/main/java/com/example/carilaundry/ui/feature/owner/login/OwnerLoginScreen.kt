...
fun OwnerLoginScreen(
    ...
    Surface(modifier = modifier.fillMaxSize(), color = MaterialTheme.colorScheme.background) {
        Column(
            ...
            Text(text = "Masuk Owner", style = MaterialTheme.typography.headlineSmall)
            ...
            TextButton(onClick = onSwitchToCustomer, modifier = Modifier.wrapContentWidth()) {
                Text(text = "Masuk sebagai Customer")
            }
        }
    }
}
